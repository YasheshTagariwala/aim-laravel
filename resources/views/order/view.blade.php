            ...
            <div class="container">
                <div class="vtab-nav clearfix vtab-nav-hrz">
                    <ul class="resp-tabs-list clearfix">
                        ...
                        <li class="" id="marketplace"><a href="{{url('/market-place/dashboard')}}">Market Place </a>
                        </li>
                        </a>
                    </ul>
                    <ul class="resp-tabs-list right-tab  clearfix">
                        <li class="side_menu" id="messages"><a href="{{url('/messages')}}"><i class="fa fa-commenting"
                ...
                <div class="resp-tab">
                    ...
                    <div class="woocommerce-MyAccount-content">
                        <p>Order #
                            <mark class="order-number">{{$order->order_no}}</mark>
                            was placed on
                            <mark class="order-date">{{date('F d, Y',strtotime($order->created_at))}}</mark>
                            and is currently
                            ...
                            @foreach($order->orderProducts as $product)
                                <tr class="order_item">
                                    <td class="product-name">
                                        <a href="{{url('/product/'.$product->product_id)}}">{{$product->product->name}}</a>
                                        <strong class="product-quantity">&times; {{$product->qty}}</strong> </td>
                                ...
                                @php $total += ($product->product_price) @endphp
                            @endforeach
                            </tbody>
                            <tfoot>
                            <tr>
                        ...
                        <address class="billing-details">
                            {{$order->orderAddress->appartmentno}},<br>{{$order->orderAddress->address}},<br>
                            {{$order->orderAddress->country}},{{$order->orderAddress->state}},{{$order->orderAddress->city}}
                        </address>
