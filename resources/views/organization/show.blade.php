            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-5">
                        <div class="thumb_logo"><img src="{{$organization[0]->org_logo}}" alt="Testing Women by Acropolis" class="details-logo" id="" ></div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <h2> {{$organization[0]->name}} <span class="wpfp-span">
                        ...
                        <p class="text-left"><i class="fa fa-map-marker" aria-hidden="true"></i> {{$organization[0]->country}}</p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-3 col-md-6 col-sm-8 col-xs-7 col-ns-12">
                        <div>
                            <span>
                                <a href="#">Home</a></span>  / <span><a class="active" href="#">{{$organization[0]->name}}</a>
                            </span>
                        </div>
                    </div>
                                    ...
                                    <div class="panel panel-default panel-faq">
                                        ...
                                        <div id="faq-cat-1-sub-1" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                            <div class="panel-body">
                                                <p><span lang="">{{$organization[0]->description}}</span></p>
                                    ...
                                    <div class="panel panel-default panel-faq">
                                        ...
                                        <div id="faq-cat-1-sub-2" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                            <div class="panel-body summery-body">
                                                <div>
                                                    <div class="col-md-6 col-sm-6 col-xs-4 prior-year">
                                                        <p>Founded Date</p>
                                                        <h1>{{$organization[0]->founded_date}}</h1>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-4 current-year">
                                                        <p>Mission</p>
                                                        <h1>{{$organization[0]->mission}}</h1>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div style="padding-top:5px;">
                                                    <div class="text-center sub-industry">Categories<h4>
                                                        <?php $input=$organization[0]->categories; 
                                                        if(strpos($input,'1')==0){ echo 'Diaspora,'; }
                                                        if(strpos($input,'2')==0){ echo 'Social Entrepreneur,'; }
                                                        if(strpos($input,'3')==0){ echo 'Uncategorized,'; }
                                                        if(strpos($input,'4')==0){ echo 'Women,'; }
                                                        if(strpos($input,'5')==0){ echo 'Youth'; } ?></h4></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4 animated slideInRight">
                        <div class="right-content">
                            ...
                            <div class="btn-businessplan  btn-invest">
                                <img src="{{url('/assets_new')}}/images/business-plan-icon.png" alt="" pagespeed_url_hash="53345294" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" width="49" height="35"><a href="" target="new"><span>Organization Details</span></a>
                           </div>
                            <div>
                                <p>Founded Date</p>
                                <span>{{$organization[0]->founded_date}}</span>
                            </div>
                            <div>
                                <p>Mission</p>
                                <span><span lang="">{{$organization[0]->mission}}</span></span>
                            </div>
                            <div>
                                <p>Country of Interest</p>
                                <span>{{$organization[0]->country}}</span>
                            </div>
                            <div>
                                <p>Documents</p>
                                <span><span lang=""><a href="{{$organization[0]->org_file}}" download="">Download File</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/funding" method="post" id="payment-form">
                            ...
                            <input type="hidden" name="project_id" value="{{$organization[0]->created_by}}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="business-details">
                            <li><h3>Idea</h3><span lang=""><p>{{$organization[0]->name}} </p></span></li>
                            <li><h3>Business Model</h3><span lang=""><p>{{$organization[0]->name}}</p></span></li>
                            <li><h3>Customer</h3><span lang=""><p>{{$organization[0]->name}}</p></span></li>
                            <li><h3>Market</h3><span lang=""><p>{{$organization[0]->name}}</p></span></li>
                            <li><h3>Industry</h3><span lang="">{{$organization[0]->name}}</span></li>
                            <li><h3>Product</h3><span lang="">{{$organization[0]->name}}</span></li>
                            <li><h3>Campaign</h3><span lang="">{{$organization[0]->name}}</span></li>
                            <li><h3>Budget</h3><span lang="">{{$organization[0]->name}}</span></li>
                            <li><h3>Pitch</h3>{{$organization[0]->name}}</li>
                        </ul>
                    </div>
                </div>
            </div>
