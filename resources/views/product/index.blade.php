        ...
        <div id="content" role="main">
            <nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
                <div class="breadcrumb">
                    <div class="container">      
                        <ul><a href="{{url('/')}}/market-place">Home</a>&nbsp;/&nbsp;<a href="#">Women</a>&nbsp;/&nbsp;{{$product->name}}</ul>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 images text-center">   
                                <a href="{{$product->imagepath}}" itemprop="image" class="col-sm-9 woocommerce-main-image zoom" title="" data-rel="prettyPhoto">
                                    <img src="{{$product->imagepath}}" class="attachment-shop_single size-shop_single wp-post-image" alt="5" title="5" srcset="{{$product->imagepath}} 300w, {{$product->imagepath}} 150w, {{$product->imagepath}} 180w" sizes="(max-width: 300px) 100vw, 300px" pagespeed_url_hash="816394685" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" width="300" height="300">
                                </a>    
                            </div>
                            <div class="col-md-6  col-sm-6 col-xs-12  summary entry-summary">
                                <div class="produ_decrip"><h6 itemprop="name" class="product_title entry-title">{{$product->name}}</h6>
                                    <div itemprop="offers" itemscope="" itemtype="">
                                        <p class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>{{$product->sale_price}}</span></p> 
                                    </div>
                                    <div itemprop="description">
                                        <p>{{$product->description}}</p>
                                    </div>
                                    <div class="product_meta"></div>
                                    <form class="cart" action="{{url('/')}}/buynow"  method="post" enctype="multipart/form-data">{{csrf_field()}}
