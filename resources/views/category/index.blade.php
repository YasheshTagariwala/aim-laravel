...
@section('title','Details By Category ')
@section('pagebody')
                        ...
                        <a href="#" data-toggle="modal" title="" data-target="#projectInfo4768">
                            <div class="list-content ">
                                <div class="col-md-6 col-sm-6 col-xs-6 list-icon listcont1 text-center " style="height: 200px;">                    
                                    <div class="thumb_logo"><img src="{{url('/')}}/assets_new/images/logo-296x300.jpg" alt="Testing Women by Acropolis"></div>                    
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 vot-info listcont1" style="height: 200px;">
                                    <h3>Testing Women by Acropolis</h3>                     
                                    <div class="rating">
                                        <font class="text-left">
                                            <i class="fa fa-map-marker" aria-hidden="true"></i>,India<div id="stars-default" class="inner-star"></div>
                                        </font>
                                    </div>
                                    <font class="text-left">
                                    ...
                                    <div class="modal-content">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="popup-banner">
                                                        ...
                                                        <figure class="text-center">
                                                            <img src="{{url('/')}}/assets_new/images/logo-296x300.jpg" alt="Testing Women by Acropolis" >
                                                        </figure>
                                                            ...
                                                            <div id="faq-cat-1-sub-2" class="panel-collapse popup_summnery">
                                                                <div class="panel-body summery-body padding-none">
                                                                    <div class="  ">
                                                                        ...
                                                                        <div class=" padding-t-10 ">
                                                                            <div class="disp-tbl w-100">
                                                                                <div class=" col-sm-6 employees dis-tcell ">  
                                                                                    <div class="text-center ">Employees<h4></h4></div>
                                                                                </div>
                                                                        ...
                                                                        <div class="more-link">  
                                                                            <a href="category-view-details.html"><button type="button" class="btn btn-default">More Details</button></a>
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="popup-footer text-center">
                                            <div class="col-sm-12">
                                                ...
                                                <p class="padding-t-10 "><button type="button" class="btn btn-default" onclick="location.href ='#'">Login</button></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
