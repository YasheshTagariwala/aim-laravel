                                ...
                                <div class="dashboard-section">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @else
                                            <div class="alert alert-warning alert-dismissable" > There Are No Investors In Your Locality</div>
                                            @endif @endif
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    @foreach($organizations as $organization)                
                                                                <tr>
                                                                    ...
                                                                    <th ><a href="{{url('/organization')}}/{{$organization->id}}">{{$organization->name}}</a></th>
                                                    ...
                                                    @else
                                                        <div class="alert alert-warning alert-dismissable">There Are No Organizations.</div>
                                                    @endif     
                                                    </div>              
                                                </div>        
                                            </div>
                                        ...
                                        <div class="cust-afc-ifrm" >
                                            <form id="post" class="" @if(count($entrepreneur) > 0) action="{{url('/')}}/entrepreneur/{{$entrepreneur[0]->id}}/update" @else action="{{url('/')}}/entrepreneur/store" @endif method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Business Name  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="name" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->name}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Idea...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Logo <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            @if(count($entrepreneur) > 0)
                                                             @if($entrepreneur[0]->logo != '')
                                                             <input name="logo" id="friend_name-0" value="" class="btn"  type="file">                                                            
                                                            <img src="{{$entrepreneur[0]->logo}}" alt="" height="60" width="60" />
                                                            <input name="logo1" value="{{$entrepreneur[0]->logo}}" class="btn" type="hidden">
                                                            @endif @else<input name="logo" id="friend_name-0" value="" class="btn"  type="file" required="">                                                            
                                                             @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="city" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->city}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your City...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">State  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="state" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->state}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your State...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <select name="country" class="form-control" required="" >
                                                            ...
                                                            <option value="{{$country->name}}" @if(count($entrepreneur) > 0) @if($entrepreneur[0]->country == $country->name) selected="" @endif @endif>{{$country->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Postal Code  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="zipcode" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->zipcode}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Postal code...">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">SDGs   <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                        <select name="country" class="form-control" required="" >
                                                            <option select="" value="">SDG</option>
                                                            @foreach($sdgs as $sdg)
                                                            <option value="{{$sdg->name}}" @if(count($entrepreneur) > 0) @if($entrepreneur[0]->sdg == $sdg->name) selected="" @endif @endif>{{$sdg->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Business Stage  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="website" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->website}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Website...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">LinkedIn URL   <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="linked_url" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->linked_url}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your LinkedIn URL...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="tw_url" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->tw_url}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Twitter URL...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Facebook URL  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="fb_url" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->fb_url}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Facebook URL...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="blog_url" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->blog_url}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Blog URL...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Google+ URL  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="gp_url" id="friend_name-0" @if(count($entrepreneur) > 0) value="{{$entrepreneur[0]->gp_url}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Google+ URL...">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <textarea class="form-control" name="overview"  required="" placeholder="Enter Your Company Overview..."> @if(count($ent_company) > 0) {{$ent_company[0]->overview}} @endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>  
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            <label style="display: block;">Categories  <span class="acf-required">*</span> <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="p_yr_revenue" id="friend_name-0"  @if(count($ent_company) > 0) value="{{$ent_company[0]->p_yr_revenue}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Prior Year Revenue...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Current Year Revenue  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="c_yr_revenue" id="friend_name-0"  @if(count($ent_company) > 0) value="{{$ent_company[0]->c_yr_revenue}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Current Year Revenue...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="n_yr_revenue" id="friend_name-0"  @if(count($ent_company) > 0) value="{{$ent_company[0]->n_yr_revenue}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Next Year Revenue...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="no_employee" id="friend_name-0"  @if(count($ent_company) > 0) value="{{$ent_company[0]->no_employees}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter the no. of employees...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <input name="filepath1" id="friend_name-0" value="" class="btn"  type="file">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="filetitle1" id="friend_name-0" @if(count($ent_company) > 0) value="{{$ent_company[0]->filetitle}}" @else value="" @endif class="form-control"  type="text" placeholder="Enter Your File Title...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="fileurl1" id="friend_name-0" @if(count($ent_company) > 0) value="{{$ent_company[0]->fileurl}}" @else value="" @endif class="form-control"  type="text" placeholder="Enter Your File URL...">
                                                                    </div>
                                                                </div><hr>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                            <input name="filepath{{$docrow}}" id="friend_name-0" value="" class="btn"  type="file">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="filetitle{{$docrow}}" id="friend_name-0"  class="form-control"  type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="fileurl{{$docrow}}" id="friend_name-0" class="form-control"  type="text" placeholder="Enter Your File URL...">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                <?php } ?>
                                                                ...
                                                                <div class="acf-form-submit">
                                                                    <input value="Add More" class="button button-success button-large" type="button" onclick="add_docs();">
                                                                </div> 
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="panel_182" >
                                        ...
                                        <div class="cust-afc-ifrm" >
                                            <form id="post" class="" action="{{url('/')}}/entrepreneur/store" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <div class="repeater-cust">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="name1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter Your Product Name...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <textarea name="description1" class="form-control" required="" placeholder="Enter Your Product Description..."></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="name{{$productrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your Product name..." >
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <textarea name="description{{$productrow}}" class="form-control" placeholder="Enter Your Product Description..."></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
                                                ...
                                                <div class="acf-form-submit">
                                                    <input value="Add More" class="button button-success button-large" type="button" onclick="add_product();">
                                                </div>
                                                <div class="acf-form-submit">
                                                    <input value="Save" class="button button-primary button-large" type="submit">
                                                </div><hr>
                                            ...
                                            <form id="post" class="" action="{{url('/')}}/entrepreneur/store" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <div class="repeater-cust"> 
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="market1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter the market...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="market_size1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter the market size...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="growth_rate1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter the Annual Growth Rate...">
                                                                    </div>
                                                                </div><!-- 
                                                                <div class="acf-form-submit">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="market{{$marketrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your Market...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="market_size{{$marketrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter the Market Size..." >
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="growth_rate{{$marketrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter the Annual Growth Rate...">
                                                                    </div>
                                                                </div>
                                                            </div>   <?php } ?> 
                                                            </div>
                                                ...
                                                <div class="acf-form-submit">
                                                    <input value="Add More" class="button button-success button-large" type="button" onclick="add_market();">
                                                </div>
                                                <div class="acf-form-submit">
                                                    <input value="Save" class="button button-primary button-large" type="submit">
                                                </div>
                                       ...
                                       <div class="cust-afc-ifrm" >
                                            <form id="post" class="" action="{{url('/')}}/entrepreneur/store" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">    
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            <label style="display: block;margin-bottom:20px;">Management  </label>
                                                            <div class="repeater-cust"> 
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="name1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter Your Name...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="position1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter Your Position...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="email1" id="friend_name-0" value="" class="form-control"  type="email" required="" placeholder="Enter Your Email...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <textarea name="description1" class="form-control"  type="text" required="" placeholder="Enter the Description..."></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                    <input name="photograph1" id="friend_name-0" value="" class="btn"  type="file">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="linked_url1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter Your LinkedIn URL...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="fb_url1" id="friend_name-0" value="" class="form-control"  type="text" required=""placeholder="Enter Your Facebook URL...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="tw_url1" id="friend_name-0" value="" class="form-control"  type="text" required="" placeholder="Enter Your Twitter URL...">
                                                                    </div>
                                                                </div><!-- 
                                                                <div class="acf-form-submit">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="name{{$teamrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your Name...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="position{{$teamrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your Position...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="email{{$teamrow}}" id="friend_name-0" value="" class="form-control"  type="email" placeholder="Enter Your Email...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <textarea name="description{{$teamrow}}" class="form-control"  type="text" placeholder="Enter the Description..." ></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                    <input name="photograph{{$teamrow}}" id="friend_name-0" value="" class="btn"  type="file">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="linked_url{{$teamrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your LinkedIn URL...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="fb_url{{$teamrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your Facebook URL...">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="tw_url{{$teamrow}}" id="friend_name-0" value="" class="form-control"  type="text" placeholder="Enter Your Twitter URl...">
                                                                    </div>
                                                                </div><!-- 
                                                                <div class="acf-form-submit">
                                                                    <input value="Add New Team Member" class="btn" type="submit">
                                                ...
                                                <div class="acf-form-submit">
                                                    <input value="Add More" class="button button-success button-large" type="button" onclick="add_team();">
                                                </div>
                                                <div class="acf-form-submit">
                                                    <input value="Save" class="button button-primary button-large" type="submit">
                                                </div>
                                                    ...
                                                    @foreach($ent_mgmnt_team as $ent_mgmnt)                
                                                                <tr>
                                                                    <td><img src="{{$ent_mgmnt->photograph}}" class="gravatar img-circle  avatar avatar-50 um-avatar" width="50" height="50" alt=""></td>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="goal" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->goal}}" @else value="" @endif class="form-control"  type="text" required="" required="" placeholder="Enter Your Goal...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Fund Raised So Far <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="fund_for" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->fund_for}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter the fund raised so far...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="fund_pvt" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->fund_pvt}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter the Private Funding...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="pre_money" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->pre_money}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Pre-Money valuation...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Interest / Dividend <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="interest" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->interest}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter the Interest...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="prev_fund" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->prev_fund}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter the Previous funding...">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Funding Commitments <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                            <input name="fund_commitment" id="friend_name-0" @if(count($ent_funding) > 0) value="{{$ent_funding[0]->fund_commitment}}" @else value="" @endif class="form-control"  type="text" required="" placeholder="Enter Your Funding Commitments...">
                                                        </div>
                                                    </div>
                                                </div>
                               ...
                               <!--  <img src="{{url('/')}}/assets_new/images/business-plan-images.png" alt="" /> -->
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="idea1" class="form-control"  type="text" required="" placeholder="Enter Your Idea..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Business Model  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="women_model1" class="form-control"  type="text" required="" placeholder="Enter Your Business model..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="customer1" class="form-control"  type="text" required="" placeholder="Enter Your Customer..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Market  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="market1" class="form-control"  type="text" required="" placeholder="Enter Your Market..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="industry1" class="form-control"  type="text" required="" placeholder="Enter Your Industry..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Product  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="product1" class="form-control"  type="text" required="" placeholder="Enter Your Product..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="campaign1" class="form-control"  type="text" required="" placeholder="Enter Your Campaign..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Budget  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="budget1" class="form-control"  type="text" required="" placeholder="Enter Your Budget..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="team1" class="form-control"  type="text" required="" placeholder="Enter Your Team..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Pitch  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="pitch1" class="form-control"  type="text" required="" placeholder="Enter Your Pitch..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Idea  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="idea{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Idea..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Business Model  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="women_model{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Business model..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Customer  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="customer{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Customer..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Market  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="market{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Market..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Industry  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="industry{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Industry..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Product  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="product{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Product..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Campaign  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="campaign{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Campaign..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Budget  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="budget{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Budget..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Team  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="team{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Team..."></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Pitch  <!-- <i class="fa fa-question-circle" ></i> --></label>
                                                    <textarea name="pitch{{$planrow}}" class="form-control"  type="text" placeholder="Enter Your Pitch..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="acf-form-submit">
                                        <input value="Add More" class="button button-success button-large" type="button" onclick="add_plan();">
                                        </div>
                                        <div class="acf-form-submit">
                                            <input value="Save" class="button button-primary button-large" type="submit">
                                        </div>
